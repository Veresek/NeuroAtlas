		...
		<div>
			...
			<div className="fixed bottom-3 right-3 group">
				<svg
					...
					viewBox="0 0 20 20"
					fill="currentColor"
					className="w-4 h-4 text-muted-foreground/40 hover:text-muted-foreground/70 cursor-pointer">
					<path
						fillRule="evenodd"
				...
				<div
					className={`absolute bottom-full right-0 mb-1 bg-popover text-popover-foreground border rounded-md shadow-md p-2 text-[10px] max-w-64 leading-snug z-10 ${creditsOpen ? "block" : "hidden group-hover:block"}`}>
